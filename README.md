...
- Auth: email/password, Google login, and Login with Apple.
- Data: PostgreSQL.
- Calendar imports: PDF, URL, ICS, Google Calendar, and Outlook Calendar.
- Parsing: hybrid deterministic + LLM-assisted extraction with parent review.
- Initial source corpus: UCLA, Vanderbilt, and Saratoga High School / Los Gatos-Saratoga Union High School District.
